...
sed -i "s~{{WG_ACCESS_LOG}}~${WG_ACCESS_LOG:-/dev/stdout}~g" $NGINX_PATH
sed -i "s~{{WG_ERROR_LOG}}~${WG_ERROR_LOG:-/dev/stdout}~g" $NGINX_PATH
sed -i "s/{{WG_ERROR_LEVEL}}/${WG_ERROR_LEVEL:-info}/g" $NGINX_PATH
